...
## Run the Code
1. Download 'data.json', keyframes features, video motion features and audio features from FakeSV(https://github.com/ICTMCG/FakeSV/blob/main/dataset/data.json) and place them in the 'data/' directory.
